                            ...
                            options: {
                                ...
                                plugins: (loader) => [
                                    require('postcss-plugin-px2rem')({
                                        ...
                                        //propBlackList: [], //黑名单
                                        exclude: /static|plugin|notFound|qualityManage|components|table|workOrder/i ,  //默认false，可以（reg）利用正则表达式排除某些文件夹的方法，例如/(node_module)/ 。如果想把前端UI框架内的px也转换成rem，请把此属性设为默认值
