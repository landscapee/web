<template>
    <div class="wscn-http404-container">
        <div class="wscn-http404">
            ...
            <div class="bullshit">
                <div class="bullshit__oops">您暂无该页面权限！</div>
                <div class="bullshit__info">
                    返回上一页面
                    <a style="color:#20a0ff" href="#" @click.prevent="fanhui" target="_blank">点我</a>
                </div>
                <!--<div class="bullshit__headline">{{ message }}</div>-->
                <div class="bullshit__info">
                    如需更换账号请：
                </div>
                <a href="" class="bullshit__return-home">重新登陆</a>
            </div>
        </div>
    </div>
</template>
...
<script>
    import newimg404 from './assets/img/new404.png'
