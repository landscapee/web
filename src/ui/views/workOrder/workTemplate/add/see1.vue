        ...
        <div class="order">
            ...
            <div class="item" >
                ...
                <el-row  v-if="form.contentVOList&&form.contentVOList.length" v-for="(opt,index) in form.contentVOList" :key="index" >
                    ...
                    <el-col :span="4"  v-if="get(form.labelVO,'contentLayout')=='C3（三列）'||get(form.labelVO,'contentLayout')=='C4（四列）'" class="colContent">

                        <div  >
                            <div v-if="opt.contentDetails&&opt.contentDetails.length" >
                                <div v-for="(k,l) in opt.contentDetails" :key="l"   :class="l>0? 'borderTop ':''"   >
                                    <div v-if="!opt.workerLabel" class="duijiao"></div>
                    ...
                    <el-col :span="4" v-if="get(form.labelVO,'contentLayout')=='C4（四列）'" class="colContent">
                        <div  >
                            <div v-if="opt.contentDetails&&opt.contentDetails.length" >
                                <div v-for="(k,l) in opt.contentDetails" :key="l"  :class="l>0?'borderTop':''">
                                    <div v-if="!opt.commanderLabel "  class="duijiao"></div>
                                </div>
                            </div>
                            <div v-else>
                                <div v-if="!opt.commanderLabel "  class="duijiao"></div>
