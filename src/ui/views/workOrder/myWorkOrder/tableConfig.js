...
export const  Config = (obj,arr,arr1,arr2,arr3) => {
    ...
    return [
        ...
        { prop: 'workTime',width:'100', label: '任务日期',formatter:timeInfo1, sortProp:"workTime", align: 'center',sort:true ,search:{type:'date', prop:'workTime',placeholder:"请选择"} },
        { prop: 'isOffline',width:'90', label: '线上/线下', sortProp:"isOffline", align: 'center',sort:true,search:{type:'input', prop:'isOffline',data:[{label:"线上",value:"线上"},{label:"线下",value:"线下"}],placeholder:"请输入"}},
        { prop: 'serialNo', label: '工单流水号',sortProp:"serialNo", align: 'center',sort:true,search:{type:'input', prop:'serialNo',placeholder:"请输入"} },

        { prop: 'template.code',width:'120',label: '工单模板编码',sortProp:"code", align: 'center',sort:true,search:{type:'input', prop:'code',placeholder:"请输入"} },
        { prop: 'template.title', label: '工单名称',sortProp:"title", align: 'center',sort:true,search:{type:'input', prop:'title',placeholder:"请输入"} },
         { prop: 'template.type',   formatter:worktype,label: '工单类型',sortProp:"type", align: 'center',sort:true,search:{type:'select', prop:'type',placeholder:"请选择",data:obj.worldorderType,selectProp:['valData','valCode'] } },

        { prop: 'airlineCompanyCode',   label: '航司代码',sortProp:"airlineCompanyCode", align: 'center',sort:true,search:{type:'input', prop:'airlineCompanyCode',placeholder:"请输入",data:arr,selectProp:['name','id'] } },
        { prop: 'airlineCompanyName',   label: '航司名称',sortProp:"airlineCompanyName", align: 'center',sort:true,search:{type:'input', prop:'airlineCompanyName',placeholder:"请输入" ,data:arr1,selectProp:['name','id']} },
        { prop: 'airplaneIcao',width:'70',label: '机型',sortProp:"airplaneIcao", align: 'center',sort:true,search:{type:'input', prop:'airplaneIcao',placeholder:"请输入",data:arr2,selectProp:['name','id'] } },
        { prop: 'flightState',  label: '航班类型', sortProp:"flightState", align: 'center',sort:true,search:{type:'select', prop:'flightState',placeholder:"请选择",data:obj.W_flightType,selectProp:['valData','valData']} },
        ...
        { prop: 'state',   label: '工单状态',formatter:state, sortProp:"state", align: 'center',sort:false },
        { slot: 'option', label: '操作' ,width:'70',search:{fixed:"right",type:'btn',label:'搜索',icon:"table_search"}}
    ]
};
