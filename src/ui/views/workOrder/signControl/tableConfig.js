...
export const  Config = (obj ) => {
    ...
    return [
        ...
        { prop: 'airlineCompanyCode',   label: '航司代码',sortProp:"airlineCompanyCode", align: 'center',sort:true,search:{type:'input', prop:'airlineCompanyCode',placeholder:"请输入"  } },
        ...
        { prop: 'airplaneIcao',width:'70', label: '机型',sortProp:"airplaneIcao", align: 'center',sort:true,search:{type:'input', prop:'airplaneIcao',placeholder:"请输入", } },
        ...
        { prop: 'template.jobType',   label: '作业类型',formatter:jobType, sortProp:"jobType", align: 'center',sort:true,search:{type:'select', prop:'jobType',placeholder:"请选择",data:obj.W_workType,selectProp:['valData','valCode']} },
        ...
        { slot: 'option', label: '操作' ,width:'90',search:{fixed:"right",type:'btn',label:'搜索',icon:"table_search"}}
    ]
};
