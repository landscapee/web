            ...
            <el-form label-position="right" :model="form" :rules="rules" ref="form">
                <div class="row_custom6">
                    <el-form-item label="信息类型：" prop="type">
                        ...
                        <el-select v-else v-model="form.type" placeholder="请选择信息类型">
                            <el-option v-for="item in infoType" :key="item.valCode" :label="item.valData"
                    ...
                    <el-form-item label="接收人和单位：">
                        <div class="tagBox">
                            <el-scrollbar style="height:100px">
                                <el-tag :key="tag.id" v-for="tag in userList" closable :disable-transitions="false"
                ...
                <div class="row_item_row row_item" v-if="form.require">
                    <el-form-item label="要求处理时间：" prop="deadline">
                        ...
                        <el-date-picker v-model="form.deadline" type="date" placeholder="请选择要求处理时间"
                        ...
                        if (valid) {
                            ...
                            request({
                                ...
                                data: this.type == "edit" ? {
                                    ...
                                    receiptDepartment: this.receiptDepartment,
                                    receiptPerson: this.receiptPerson,
                                    subscribeId: this.subscribeId,
                                    bySubscribe: this.bySubscribe
                                } : {
                                    ...this.form,
                                    receiptDepartment: this.receiptDepartment,
                                    receiptPerson: this.receiptPerson,
