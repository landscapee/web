...
export const warningConfigTable = () => {
    return [
        ...
        { prop: 'subject', label: '预警名称', align: 'center',sort:true,sortProp:"subjectMode",search:{prop:'subject',type:'input',placeholder:"请输入预警名称"} },
        { prop: 'contentTemplate', label: '预警模板', align: 'center',sort:true,sortProp:"contentTemplateMode",search:{prop:'contentTemplate',type:'input',placeholder:"请输入预警模板"} },
...
export const subscribeConfigTable = (infoSelect) => {
    return [
        ...
        },align: 'center',sort:true,sortProp:"enableMode",search:{prop:'enable',type:'select',data:[{label:"是",value:true},{label:"否",value:false}],placeholder:"请选择是否启用"} },
...
export const infoPlateSendTable = (infoSelect) => {
    return [
        ...
        },align: 'center',sort:true,sortProp:"stateMode",search:{prop:'state',type:'input',placeholder:"请输入信息状态"} },
        { slot: 'relationInfo', label: '操作' ,width:'148',search:{fixed:"right",type:'btn',label:'搜索',icon:"table_search"}}
    ]
};
