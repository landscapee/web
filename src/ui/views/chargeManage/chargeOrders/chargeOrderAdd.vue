					...
					<div>
						<el-row>
							...
							<template v-else>
								<el-col :span="12">
									<!--/Man hour-->
									<el-form-item label="非例行维护服务技术人员" prop="nonroutineServiceTechnicians" :label-width='labelWidth'>
								<span v-if="isInfo" class='form_inlne_val'
									  style='width:95px;'>{{ruleForm.nonroutineServiceTechnicians}}</span>
										<el-input v-else v-model="ruleForm.nonroutineServiceTechnicians" @input="changeCode('nonroutineServiceTechnicians','number')"
												  style='width:119px;'></el-input>
								...
								<span v-if="isInfo" class='form_inlne_val'
									  style='width:95px;'>{{ruleForm.nonroutineServiceTechniciansTime}}</span>
										<el-input v-else v-model="ruleForm.nonroutineServiceTechniciansTime" @input="changeCode('nonroutineServiceTechniciansTime','hours')"
												  style='width:118px;'></el-input>
										<span class='form_inlne_val1'>小时</span>
									</el-form-item>
								</el-col>
								<el-col :span="12">
									<!--/Man hour-->
									<el-form-item label="非例行维护服务工程人员" prop="nonroutineServicePersons" :label-width='labelWidth'>
								<span v-if="isInfo" class='form_inlne_val'
									  style='width:95px;'>{{ruleForm.nonroutineServicePersons}}</span>
										<el-input v-else v-model="ruleForm.nonroutineServicePersons" @input="changeCode('nonroutineServicePersons','number')"
												  style='width:119px;'></el-input>
										<!--/Man--><span class='form_inlne_val1' style="margin-right: 10px">人</span>
									</el-form-item>
									<el-form-item >
								<span v-if="isInfo" class='form_inlne_val'
									  style='width:95px;'>{{ruleForm.nonroutineServicePersonsTime}}</span>
										<el-input v-else v-model="ruleForm.nonroutineServicePersonsTime" @input="changeCode('nonroutineServicePersonsTime','hours')"
												  style='width:118px;'></el-input>
										<span class='form_inlne_val1'>小时</span>
									</el-form-item>
								</el-col>
								...
								<span v-if="isInfo" class='form_inlne_val'
									  style='width:95px;'>{{ruleForm.deicingPersons}}</span>
										<el-input v-else v-model="ruleForm.deicingPersons" @input="changeCode('deicingPersons','number')"
												  style='width:119px;'></el-input>
										<!--/Man--><span class='form_inlne_val1' style="margin-right: 10px">人</span>
									</el-form-item>
									<el-form-item >
								<span v-if="isInfo" class='form_inlne_val'
									  style='width:95px;'>{{ruleForm.deicingPersonsTime}}</span>
										<el-input v-else v-model="ruleForm.deicingPersonsTime" @input="changeCode('deicingPersonsTime','hours')"
												  style='width:118px;'></el-input>
										<span class='form_inlne_val1'>小时</span>
									</el-form-item>
								</el-col>
						...
						<el-row>
							...
							<template v-else>
								<el-col :span="12">
 									<el-form-item label="充氮、冷气（减震栓系统）" prop="damperSystemsTimes"
										...
										<el-input v-else v-model="ruleForm.damperSystemsTimes" @input="changeCode('damperSystemsTimes','number')"
												  style='width:280px;'></el-input>
							...
							<el-col :span="12">
								<el-form-item label="轮轴千斤顶" prop="jack" :label-width='labelWidth'>
									<span v-if="isInfo" class='form_inlne_val' style='width:280px;'>{{ruleForm.jack}}</span>
							...
							<el-col :span="12">
								...
								<span v-if="isInfo" class='form_inlne_val'
									...
									<el-input v-else v-model="ruleForm.metalTape" @input="changeCode('metalTape','number')"
											  style='width:280px;'></el-input>
							...
							<template v-if="ruleForm.inOrOut">
								...
								<span v-if="isInfo" class='form_inlne_val'
									  style='width:280px;'>{{ruleForm.oil2197}}</span>
										<el-input v-else v-model="ruleForm.oil2197" @input="changeCode('oil2197','kilogram')"
												  style='width:280px;'></el-input>
										<span class='form_inlne_val1'>夸脱</span>
									</el-form-item>
								</el-col>
							...
							<el-col :span="12" v-else>
								...
								<span v-if="isInfo" class='form_inlne_val'
									...
									<el-input v-else v-model="ruleForm.oil" @input="changeCode('GjHY2197__','oil')"
											  style='width:280px;'></el-input>
									<span class='form_inlne_val1'>夸脱</span>
								</el-form-item>
							</el-col>
							...
							<el-col :span="12">
								<el-form-item label="工作梯" prop="workLadder" :label-width='labelWidth'>
									...
									<el-input v-else v-model="ruleForm.workLadder" @input="changeCode('workLadder','number')"
											  style='width:280px;'></el-input>
									<span class='form_inlne_val1'>次</span>
								</el-form-item>
							</el-col>
