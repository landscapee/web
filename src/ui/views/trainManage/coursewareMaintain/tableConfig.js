...
export const coursewareConfig = (obj) => {
        return [
                ...
                { prop: 'active',width:80, label: '是否启用', sortProp:"active", align: 'center',sort:true,search:{type:'select', prop:'active',selectProp:['valData','valData'],data:obj.isUse ,placeholder:"请选择", } },
                { slot: 'fileDown', label: '操作',width:'120',sortProp:"description", align: 'center',sort:true,search:{type:'btn',label:'搜索',icon:"table_search"} },
         ]
};
