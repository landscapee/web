...
export const testMainAddConfig = (obj) => {
        return [
                ...
                { prop: 'optionType', label: '选择类型', sortProp:"optionType", align: 'center',sort:true, search:{type:'select', prop:'optionType',selectProp:['valData','valData'],data:obj.selectType||[],placeholder:"请选择"} },
