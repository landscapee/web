...
export const testMainConfig = (obj) => {
        return [
                ...
                { prop: 'paperType', label: '试卷类别',sortProp:"paperType", align: 'center',sort:true,search:{type:'select', prop:'paperType',selectProp:['valCode','valCode'],data:obj.paperCategory||[],placeholder:"请选择"}},
                { prop: 'testType', label: '考试类型',sortProp:"testType", align: 'center' ,sort:true,search:{type:'select', prop:'testType',selectProp:['valCode','valCode'],data:obj.testCategory||[],placeholder:"请选择"}},
                { prop: 'qualificationType', label: '考试资质类型',sortProp:"qualificationType", align: 'center' ,sort:true,search:{type:'select', prop:'qualificationType',selectProp:['valCode','valCode'],data:obj.qualificationType||[],placeholder:"请选择"}},
                { prop: 'businessType', label: '业务类型',sortProp:"businessType", align: 'center' ,sort:true,search:{type:'select', prop:'businessType',selectProp:['valCode','valCode'],data:obj.businessType||[],placeholder:"请选择"}},
                { prop: 'suitableUser', label: '适用对象',sortProp:"suitableUser", align: 'center',sort:true,search:{type:'select', prop:'suitableUser',selectProp:['valCode','valCode'],data:obj.applyObject||[],placeholder:"请选择", } },
...
export const testMainAddConfig = (obj) => {
        return [
                ...
                { prop: 'optionType', label: '选择类型', sortProp:"optionType", align: 'center',sort:true, search:{type:'select', prop:'optionType',selectProp:['valCode','valCode'],data:obj.selectType||[],placeholder:"请选择"} },
