export const sysParameterTable = () => {
    return [
        ...
        { prop: 'startTime', label: '生效日期', align: 'center',search:{prop:'startTime',type:'date',placeholder:"请输入生效日期"}},
        { prop: 'endTime', label: '有效期至', align: 'center',sort:true,sortProp:"endTime",search:{prop:'endTime',type:'date',placeholder:"请输入有效期至"} },
        { prop: 'userName', label: '上传人', align: 'center',sort:true,sortProp:"userName",search:{prop:'userName',type:'input',placeholder:"请输入上传人"} },
        { prop: 'createTime', label: '上传时间', align: 'center',sort:true,sortProp:"createTime",search:{prop:'createTime',type:'date',placeholder:"请输入上传时间"} },
