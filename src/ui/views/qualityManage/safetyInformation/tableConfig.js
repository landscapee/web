...
export const sadetyInfoConfig = () => {
        return [
                ...
                { prop: 'infTime', label: '时间',formatter:timeInfo,width:'148',sortProp:"infTime", align: 'center',sort:true,search:{type:'date', prop:'infTime',placeholder:"请选择时间"}},
                ...
                { prop: 'situation', label: '违规/差错',width:'148',sortProp:"situation", align: 'center',sort:true,search:{type:'select', prop:'situation',placeholder:"请选择违规/差错",data:[{label:"违规",value:"违规"},{label:"差错",value:"差错"}],} },
                ...
                {  prop: 'serviceEvents', label: '是否安全/服务事件' ,width:'148',sortProp:"serviceEvents", search:{type:'select',prop:'serviceEvents', placeholder:"请选择是否安全/服务事件", data:[{label:"类型1",value:"1"},{label:"类型2",value:"2"}],}},
