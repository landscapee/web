...
export const sadetyInfoConfig = (obj) => {
        return [
                ...
                { prop: 'responsibleUnit', label: '负责人',width:'148',sortProp:"responsibleUnit", align: 'center' ,sort:true,search:{type:'input', prop:'responsibleUnit',placeholder:"请输入"}},
                { prop: 'unit', label: '单位',width:'148',sortProp:"unit", align: 'center' ,sort:true,search:{type:'input', prop:'unit',placeholder:"请输入"}},
