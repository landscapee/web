...
export const authorizeConfig = (obj) => {
        return [
            ...
            { prop: 'authorizationType', label: '授权类型',sortProp:"authorizationType", align: 'center',sort:true,search:{type:'select', prop:'authorizationType',placeholder:"请输入",data:obj.Z_accreditType} },
            ...
            { prop: 'flightType', label: '授权航班类型',sortProp:"flightType", align: 'center',sort:true,search:{type:'select', prop:'flightType',placeholder:"请输入",data:obj.accreditFlightType} },
            { prop: 'modelRange', label: '授权机型',sortProp:"modelRange", align: 'center',sort:true,search:{type:'input', prop:'modelRange',placeholder:"请输入"} },
            { prop: 'state', label: '授权状态',formatter:state,sortProp:"state", align: 'center',sort:true,search:{type:'select', prop:'state',placeholder:"请输入",data:obj.accreditState} },
