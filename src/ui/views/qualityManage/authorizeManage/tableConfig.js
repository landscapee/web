...
export const authorizeConfig = (obj,arr) => {
    return [
        ...
        { prop: 'flightType', label: '授权航班类型',sortProp:"flightType", align: 'center',sort:true,search:{type:'select', prop:'flightTypeQuery ',placeholder:"请选择",data:obj.accreditFlightType,selectProp:['valData','valData']} },
