...
export const safetyConfig = (obj) => {
        return [
                ...
                { prop: 'deptName', label: '部门',sortProp:"deptName", align: 'center', search:{type:'select', prop:'deptName',placeholder:"请选择",data:obj.dept} },
...
export const safetyDetailsConfig = (obj) => {
        return [
                ...
                { prop: 'quotaType', label: '指标类型', sortProp:"quotaType", align: 'center',sort:true,search:{type:'select', prop:'quotaType',placeholder:"请输入指标类型",data:obj.indicateType} },
