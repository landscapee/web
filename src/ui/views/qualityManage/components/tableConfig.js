...
export const leftConfig = (obj) => {
        return [
            ...
            { prop: 'userName', label: '员工姓名',sortProp:"userName", align: 'center',sort:false,search:{type:'input', prop:'userName',placeholder:"请输入"} },
                ...
                { prop: 'certificateType', label: '资质类型',sortProp:"certificateType", align: 'center',sort:false,},
...
export const rightConfig = (obj) => {
    ...
    return [
                { slot: 'radio' , label: '选择', width:49,search:{ type:'text',label:'过滤'}},
                 { prop: 'applicableBusiness', label: '适用业务', sortProp:"applicableBusiness", align: 'center',sort:false},
...
export const authorizeConfig = (obj,arr) => {
    return [
        ...
        { prop: 'authorizationType', label: '授权类型',sortProp:"authorizationType", align: 'center',sort:true,search:{type:'select', prop:'authorizationType',placeholder:"请选择",data:obj.roleControl,selectProp:['valData','valData']} },
        { prop: 'authorizedUnit', label: '授权单位',sortProp:"authorizedUnit", align: 'center',sort:true,search:{type:'input', prop:'authorizedUnit',placeholder:"请输入"} },
...
export const trainManageUserConfig = (obj) => {
    return [
        ...
        { prop: 'trainingType',width:120, label: '类别',sortProp:"trainingType", align: 'center',sort: false },
...
export const testRuConfig = ( obj) => {
    return [
        ...
        { prop: 'examName',width:'150', label: '考试名称',  sortProp:"examName", align: 'center',sort: false  },
        { prop: 'examTime', width:'120',label: '时间',formatter:test,sortProp:"examTime", align: 'center',sort: false },
        { prop: 'totalTime',width:'100', label: '时长(分)',sortProp:"totalTime", align: 'center',sort: false, },
        { prop: 'examSite',width:'120', label: '地点',sortProp:"examSite", align: 'center' ,sort: false, },
        { prop: 'examMode', width:'100',label: '考试方式',sortProp:"examSite", align: 'center' ,sort: false, },
        { prop: 'examType',width:'100', label: '考试类型',sortProp:"examType", align: 'center' ,sort: false, },
        { prop: 'qualificationType',width:'100', label: '资质类型',sortProp:"qualificationType", align: 'center',sort: false,  },
        { prop: 'businessType',width:'100', label: '业务类型',sortProp:"businessType", align: 'center',sort: false, },
        { prop: 'paperName',width:'140', label: '试卷名称',sortProp:"paperName", align: 'center' ,sort: false, },
        // { slot: 'employeeFileId', label: '纸质试卷',sortProp:"employeeFileId", align: 'center' ,sort: false, },
        { prop: 'score', label: '分数', sortProp:"score", align: 'center',sort: false },
