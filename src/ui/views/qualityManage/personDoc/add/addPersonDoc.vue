				...
				<el-form ref="form" label-position="right" :model="form" :rules="rules" :inline="true">
					<table class="nomTable">
						<tr>
							...
							<td class="tTd">
								<el-form-item prop="userName">
                                    <span v-if="type=='info'">
                                     <el-tooltip v-if="form.userName" class="item" effect="dark"
							...
							<td class="tTd">
                                <span v-if="type=='info'">
                                    <!--{{form.nation}}-->
                                 <el-tooltip v-if="form.nation" class="item" effect="dark" :content="form.nation"
											 placement="top-start">
												<div>{{ form.nation }}</div>
                                    </el-tooltip>
                                </span>
						...
						<tr>
							...
							<td class="tTd">
                                <span v-if="type=='info'">
                                    <el-tooltip v-if="form.university" class="item" effect="dark"
							...
							<td class="sTd" colspan="2">
                                <span v-if="type=='info'">
                                    <!--{{form.major}}-->
                                <el-tooltip v-if="form.major" class="item" effect="dark" :content="form.major"
											placement="top-start">
												<div>{{ form.major }}</div>
                                    </el-tooltip>
                                </span>
		...
		data() {
			return {
				...
				rules: {
					...
					dept: [{required: true, message: '请选择部门/项目', trigger: "blur"}],
					idCard: [
						{
