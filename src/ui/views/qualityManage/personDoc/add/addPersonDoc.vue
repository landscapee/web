            ...
            <div class="G_form1" style="overflow: auto ; height:calc(100vh - 270px);">
                <el-form ref="form" label-position="right" :model="form" :rules="rules" :inline="true">
                    <table class="nomTable">
                        <tr>
                            ...
                            <td class="tTd">
                                <span v-if="type=='info'">
                                    <!--{{form.nation}}-->
                                 <el-tooltip v-if="form.nation" class="item" effect="dark" :enterable="false"
                                             :content="form.nation"
                                             placement="top-start">
												<div>{{ form.nation }}</div>
                                    </el-tooltip>
                        ...
                        <tr>
                            ...
                            <td class="sTd" colspan="2">
                                <span v-if="type=='info'">
                                    <!--{{form.major}}-->
                                <el-tooltip v-if="form.major" class="item" effect="dark" :enterable="false"
                                            :content="form.major"
                                            placement="top-start">
												<div>{{ form.major }}</div>
                                    </el-tooltip>
                        ...
                        <tr>
                            ...
                            <td class="tTd">
                                ...
                                <el-tooltip v-if="form.maintenanceEducation" class="item" effect="dark"
                                            :enterable="false"
                            ...
                            <td class="sTd" colspan="2">
                                <span v-if="type=='info'">
                                      <el-tooltip v-if="form.maintenanceUniversity" class="item" effect="dark"
                                                  :enterable="false"
                        ...
                        <tr>
                            ...
                            <td class="tTd">
                                <span v-if="type=='info'" style="">
                                    <el-tooltip v-if="form.userSuperiorNumber" class="item" effect="dark"
                                                :enterable="false"
                    ...
                    <div style="width:1160px">
                        <InOfficeInfo @getInfo="getInfo" :type="type" :userId="this.form.userId"
                                      :tableData="form.positionInfList||[]"
                                      :id="this.$route.query.id"></InOfficeInfo>
                        <WorkExperience @getInfo="getInfo" :type="type" :userId="this.form.userId"
                                        :tableData="form.workInfList||[]"
                                        :id="this.$route.query.id"></WorkExperience>
                        <Certificate @getInfo="getInfo" :type="type" :userId="this.form.userId"
                                     :tableData="form.certificateInfList||[]"
                                     :id="this.$route.query.id"></Certificate>
                        <Unsafe @getInfo="getInfo" :type="type" :userId="this.form.userId"
                                :tableData="form.sincerityInfList||[]"
        ...
        methods: {
            ...
            initPage() {
                if (this.$route.query) {
                    ...
                    let url = `/sys/user/getAllUserByDeptId`
                    if (PROGRAM !== "jwxt.prod") {
                        url = `/sys/user/getUsersByOrgId`
                        delete obj.deptId
                        obj.orgId = this.$store.state.user.userInfo.orgId
                        obj.deptRelation = false
                    }
                    request({
                        url: url,
                        method: 'get',
                        ...
                        if (valid) {
                            ...
                            request({
                                ...
                                if (d.code == 200) {
                                    ...
                                    if (this.type == "add") {
                                        this.$router.push({
                                            path: '/addPersonDoc/edit',
                                            query: {id: d.data.id, userId: d.data.userId}
                                        })
