<template>
    <div  class="useAssRecord">
        <div class="top-content">
            <div class="top-content-title">
                <span>{{$route.query.id}}-培训考核</span>
            </div>
        ...
        <div class="main-content">
            <SearchTable  @requestTable="requestTable" :noSearch="true"  @listenToCheckedChange="listenToCheckedChange" @headerSort="headerSort" @handleSizeChange="handleSizeChange" @handleCurrentChange="handleCurrentChange"  :data="tableData" :tableConfig="tableConfig"  :showHeader="false" :showPage="true" >
...
import { useAssRecordTable } from '../../tableConfig.js';
