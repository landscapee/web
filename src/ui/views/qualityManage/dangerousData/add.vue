            ...
            <el-form  label-position="right" :model="form" :rules="rules" ref="form" >
                ...
                <div class="row_custom">
                    <el-form-item label="编号：" prop="number">
                        ...
                        <el-input v-else v-model="form.number" placeholder="请输入编号"></el-input>
                    </el-form-item>
                ...
                if (this.type == "add" || this.type == "edit") {
                    this.$refs[form].validate(valid => {
                        if (valid) {
                            let url
                             if(this.type == "add"){
                                // url=`${this.$ip}/dangerData/save`
                                url=`http://173.100.1.126:3000/mock/639/dangerData/save`
                            }else {
                                url=`http://173.100.1.126:3000/mock/639/dangerData/update`
                                // url=`${this.$ip}/dangerData/update`
