...
export const rightConfig = (obj) => {
    ...
    return [
                { slot: 'radio' , label: '选择', width:49,search:{ type:'text',label:'过滤'}},
                 { prop: 'applicableBusiness', label: '适用业务', sortProp:"applicableBusiness", align: 'center',sort:true,search:{type:'select', prop:'applicableBusiness',placeholder:"请选择",selectProp:['valData','valData'],data:obj.checkProject} },
