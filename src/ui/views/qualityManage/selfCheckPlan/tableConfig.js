...
export const selfCheckDetailsConfig = (obj) => {
    ...
    return [
                ...
                { prop: 'checkProject', label: '检查项目', sortProp:"checkProject", align: 'center',sort:true,search:{type:'select', prop:'checkProject',placeholder:"请选择检查项目",selectProp:['valCode','valCode'],data:obj.checkProject} },
                ...
                { prop: 'checkMethod', label: '检查方式', sortProp:"checkMethod", align: 'center' ,sort:true,search:{type:'select', prop:'checkMethod',multiple:true,placeholder:"请选择检查方式",selectProp:['valCode','valCode'],data:obj.checkType}},
                ...
                { prop: 'checkObject', label: '检查对象', sortProp:"checkObject", align: 'center',sort:true,search:{type:'select', prop:'checkObject',placeholder:"请选择检查对象",selectProp:['valCode','valCode'],data:obj.checkObject} },
                ...
                // {  prop: 'checkType', label: '检查类别' , sortProp:"checkType", search:{type:'select',extendType:'search', prop:'checkType', placeholder:"请选择检查类别",selectProp:['valCode','valCode'],data:obj.checkCategory]}},
              ]
};
