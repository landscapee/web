    ...
    <el-container class="layout-container">
        <el-header class="layout-header">
            ...
            <div class="header-right">
                ...
                <span class="buttons"><icon iconClass="usericon"></icon>{{username}}{{workNumber?`(${workNumber})`:''}}</span>
        ...
        <el-container>
            <el-aside :class="isOpen?'open-menu':'left-menu'">
                <el-menu router :default-active="routePath" :unique-opened="true">
                    <el-submenu v-if="item.meta&&!item.hidden" :index="item.path"
                                v-for="(item,index) in permission_routes" :key="index">
                        <template slot="title">
                            <icon :iconClass="item.meta.icon"></icon>
                            <span>{{item.name}}</span>
                        </template>
                        <el-menu-item v-if="!item.hidden" :index="obj.path" v-for="obj in item.children"
                                      :key="obj.path">
                            <span>{{obj.name}}</span>
                        </el-menu-item>
                    </el-submenu>
                </el-menu>
                <icon iconClass="spread" :class="isOpen?'spread-icon open-spread-icon':'spread-icon'"
                      @click.native="onSpread"></icon>
            </el-aside>
    ...
    export default {
        ...
        data() {
            return {
                ...
                workNumber: this.$store.getters.userInfo.workNumber,
