...
export default {
	...
	methods: {
		...
		filterNode(value, data, node) {
			...
			let if_three = node.parent && node.parent.parent && node.parent.parent.label && node.parent.parent.label.indexOf(value) !== -1;
			let if_four = node.parent && node.parent.parent && node.parent.parent.parent && node.parent.parent.parent.label && node.parent.parent.parent.label.indexOf(value) !== -1;
